...
export declare function instantiateSync<T extends {}>(module: WebAssembly.Module, imports?: ImportsObject): ASUtil & T;

/** Instantiates an AssemblyScript module from a buffer (<4kB) using the specified imports. */
export declare function instantiateBufferSync<T extends {}>(buffer: Uint8Array | ArrayBuffer, imports?: ImportsObject): ASUtil & T;

/** Instantiates an AssemblyScript module from a buffer using the specified imports. */
export declare function instantiateBuffer<T extends {}>(buffer: Uint8Array | ArrayBuffer, imports?: ImportsObject): Promise<ASUtil & T>;
